            ...
            <div class="row g-4">
                <div class="col-md-8">
                    <div class="d-flex align-items-center gap-4 p-3 bg-light rounded-4 h-100">
                        @if($rental->product->gambar)
                            <img src="{{ asset('storage/'.$rental->product->gambar) }}" class="rounded-3 shadow-sm" style="width: 100px; height: 100px; object-fit: cover;">
                        @else
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex gap-4">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold small">{{ optional($rental->start_date)->format('d M') }} - {{ optional($rental->end_date)->format('d M Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="p-4 rounded-4 h-100 d-flex flex-column justify-content-between" style="background: #f8fafc; border: 1px dashed #cbd5e1;">
                        <div>
                            ...
                            <h4 class="fw-bold text-primary mb-3">Rp {{ number_format($rental->price * $rental->duration, 0, ',', '.') }}</h4>
                        </div>
