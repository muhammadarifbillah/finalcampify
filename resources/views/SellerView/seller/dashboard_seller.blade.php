    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-4 text-md-end">
            <div class="d-flex gap-2 justify-content-md-end">
                ...
                <button class="btn btn-light rounded-circle shadow-sm p-2 d-flex align-items-center justify-content-center" style="width: 45px; height: 45px;">
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        <div class="card card-modern p-5 border-0 shadow-sm h-100">
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                <div class="badge bg-light text-muted p-2 rounded-pill px-3 border fw-semibold">Mei 2026</div>
            </div>
    ...
    <div class="col-lg-4">
        <div class="card card-modern p-5 border-0 shadow-sm h-100">
            ...
            <div class="performance-item mb-5">
        ...
        <table class="table table-hover align-middle custom-table">
            <thead class="bg-light bg-opacity-50">
                <tr>
                    ...
                    <th class="border-0 px-4 py-3 text-muted small fw-bold text-uppercase ls-1">Amount</th>
            ...
            <tbody>
                ...
                <tr style="cursor: pointer;" onclick="window.location='/seller/orders/{{ $o->id }}'">
                    ...
                    <td class="px-4 py-4 fw-bold text-emerald">Rp {{ number_format($o->total, 0, ',', '.') }}</td>
