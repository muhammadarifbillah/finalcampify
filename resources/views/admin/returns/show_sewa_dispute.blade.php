                    ...
                    @else
                        <div class="space-y-4">
                            <div class="p-4 bg-emerald-50 border border-emerald-100 rounded-xl flex items-center gap-3">
                                ...
                                <div class="text-[11px] font-bold text-emerald-800 uppercase tracking-wider">Sengketa Telah Selesai (Completed)</div>
                            </div>

                            <!-- Panel Transfer Manual Admin -->
                            @if(!$return->refund_disbursed_at)
                                <div class="p-5 bg-amber-50 border border-amber-100 rounded-2xl space-y-4 text-left">
                            ...
                            @else
                                <div class="p-4 bg-emerald-100 border border-emerald-200 rounded-xl space-y-2 text-emerald-800 text-left">
